...
const TeamSidebar = ({
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <span className="text-[0.65rem] uppercase tracking-[0.3em] text-slate-400">
              {selectedTeamId === team.id ? 'Active' : 'Open'}
            </span>
          </div>
  ...
  }, [teams, selectedTeamId, onSelectTeam, currentUserId])
    ...
    <section className="flex flex-col gap-4 rounded-3xl border border-slate-200 bg-white/90 p-6 shadow-[0_25px_80px_rgba(15,23,42,0.08)]">
      ...
      <div className="space-y-3 rounded-2xl border border-slate-100 bg-slate-50/80 p-4">
        ...
        <form className="space-y-3" onSubmit={handleCreateTeam}>
          ...
          <Button type="submit" className="w-full text-xs font-semibold uppercase tracking-[0.3em]" disabled={isCreating}>
      ...
      <div className="space-y-3 rounded-2xl border border-slate-100 bg-slate-50/80 p-4">
        ...
        <form className="space-y-3" onSubmit={handleJoinTeam}>
          ...
          <Button type="submit" className="w-full text-xs font-semibold uppercase tracking-[0.3em]" disabled={isJoining}>
